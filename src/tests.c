...
START_TEST(test_load_1) {
  ...
  ck_assert_int_eq(m.poligon.poligon_data[22].lenght, 3);
  ck_assert_int_eq(m.poligon.poligon_data[22].array[0], 34);
  ck_assert_int_eq(m.poligon.poligon_data[22].array[1], 35);
  ck_assert_int_eq(m.poligon.poligon_data[22].array[2], 38);

  ck_assert_int_eq(m.poligon.poligon_data[75].lenght, 3);
  ck_assert_int_eq(m.poligon.poligon_data[75].array[0], 114);
  ck_assert_int_eq(m.poligon.poligon_data[75].array[1], 113);
  ck_assert_int_eq(m.poligon.poligon_data[75].array[2], 115);

  ck_assert_int_eq(m.poligon.poligon_data[1].lenght, 3);
  ck_assert_int_eq(m.poligon.poligon_data[1].array[0], 5);
  ck_assert_int_eq(m.poligon.poligon_data[1].array[1], 1);
  ck_assert_int_eq(m.poligon.poligon_data[1].array[2], 4);
...
START_TEST(test_load_2) {
  ...
  ck_assert_int_eq(m.poligon.poligon_data[0].lenght, 3);
  ck_assert_int_eq(m.poligon.poligon_data[0].array[0], 25);
  ck_assert_int_eq(m.poligon.poligon_data[0].array[1], 2);
  ck_assert_int_eq(m.poligon.poligon_data[0].array[2], 0);

  ck_assert_int_eq(m.poligon.poligon_data[1].lenght, 4);
  ck_assert_int_eq(m.poligon.poligon_data[1].array[0], 25);
  ck_assert_int_eq(m.poligon.poligon_data[1].array[1], 26);
  ck_assert_int_eq(m.poligon.poligon_data[1].array[2], 3);
  ck_assert_int_eq(m.poligon.poligon_data[1].array[3], 2);

  ck_assert_int_eq(m.poligon.poligon_data[7131].lenght, 4);
  ck_assert_int_eq(m.poligon.poligon_data[7131].array[0], 9172);
  ck_assert_int_eq(m.poligon.poligon_data[7131].array[1], 9173);
  ck_assert_int_eq(m.poligon.poligon_data[7131].array[2], 9453);
  ck_assert_int_eq(m.poligon.poligon_data[7131].array[3], 9452);

  ck_assert_int_eq(m.poligon.poligon_data[3632].lenght, 4);
  ck_assert_int_eq(m.poligon.poligon_data[3632].array[0], 3534);
  ck_assert_int_eq(m.poligon.poligon_data[3632].array[1], 3535);
  ck_assert_int_eq(m.poligon.poligon_data[3632].array[2], 3512);
  ck_assert_int_eq(m.poligon.poligon_data[3632].array[3], 3511);
